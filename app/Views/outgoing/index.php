...
<div class="bg-white p-6 rounded-lg shadow-md mb-8">
    <h2 class="text-xl font-semibold mb-4 text-gray-700 border-b pb-2">Form Barang Keluar</h2>
...
<div class="bg-white shadow-md rounded-lg overflow-x-auto">
    <h2 class="text-xl font-semibold p-6 text-gray-700 border-b">Log Barang Keluar</h2>
    <table class="min-w-full table-auto">
        ...
        <tbody class="text-gray-600 text-sm">
            <?php if (!empty($log)): foreach ($log as $item): ?>
                ...
                <tr>
                    <td colspan="4" class="py-4 px-6 text-center text-gray-500">Belum ada data barang keluar.</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
