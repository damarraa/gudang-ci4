...
<form action="/products" method="POST" class="bg-white p-6 rounded-lg shadow-md">
    <?= csrf_field() ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="unit" id="unit" value="<?= old('unit') ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="stock" id="stock" value="<?= old('stock', 0) ?>" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
